...
//   const [showNewVisit, setShowNewVisit] = useState<boolean>(false);

//   // Force show main content by default
//   const showMainContent = !showLogin && !showSignup && !showCompanyName && !showAbout && !showProfile && !showDashboard && !showNewVisit;
  
//   // Show WelcomePage when no other screen is active
//   const showWelcomePage = showMainContent;
...
//     console.log('Home.tsx: handleNavigateToNewVisit called');
...
//         ) : showDashboard ? (
//           <Dashboard 
//             key="dashboard-with-nav"
//             onBack={() => setShowDashboard(false)} 
//             onNavigateToNewVisit={handleNavigateToNewVisit}
//             onNavigateToWelcome={handleNavigateToWelcome}
//           />
//         ) : showNewVisit ? (
//           <NewVisit onBack={() => setShowNewVisit(false)} onNavigateToWelcome={handleNavigateToWelcome} />
//         ) : showWelcomePage ? (
//           <WelcomePage />
//         ) : (
//           <>
